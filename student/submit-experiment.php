    ...
    <div class="container py-4  maincontent">
      <div class="row py-4">
        ...
        <div class="col customcontent">
          ...
          <form>
          <div class="row py-4">
              <div class="col-md-6 sub-page-title">
                <h4>Code</h4>
                  <input type="file" class="my-file" name="code" id="code" multiple>
              </div>
              <div class="col-md-6 sub-page-title">
                <h4>Output</h4>
                <input type="file" class="my-file" name="output" id="output" multiple>
              </div>
          </div>
