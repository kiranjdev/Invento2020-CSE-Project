...
CREATE TABLE `project`.`teachers` ( `id` INT NOT NULL AUTO_INCREMENT , `name` VARCHAR(42) NOT NULL , `password` VARCHAR(150) NOT NULL , `verified` INT NOT NULL , `email` VARCHAR(50) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
